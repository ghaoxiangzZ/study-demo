package com.demo.dubbo.spi.loader;

import com.demo.dubbo.spi.annotation.SPI;
import com.demo.dubbo.spi.holder.SPIHolder;
 ...
 * @author haoxiang_guo
 * @version 1.0.0
 * @ClassName SPILoader.java
 * @Description 加载拓展点
 * @createTime 2020年05月14日 22:05:00
 */
public class SPILoader<T> {
    ...
    public T getExtension(String name) {
        ...
        if (holder == null) {
            cachedInstances.putIfAbsent(name, new SPIHolder<Object>());
